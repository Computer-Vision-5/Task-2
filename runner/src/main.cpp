...
// Assuming your original code has these in Image.hpp or another included header
// If they are in Image.hpp, make sure to include it: #include "Image.hpp"
...
int main(int argc, char** argv) {
    ...
    // Default threshold and bound parameters
